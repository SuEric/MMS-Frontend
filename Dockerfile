...
#    docker build --squash="true" -t mms-frontend .
#
...
#    docker run --name mms-frontend -p 8080:80 mms-frontend &
#
#    Run image as virtual host (read more: https://github.com/jwilder/nginx-proxy):
#    docker run -e VIRTUAL_HOST=mms-frontend.your-domain.com --name mms-frontend mms-frontend &
